...
function StaffLogin() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    if (email === "admin@eagle.com" && pw === "password" && code.length === 6) {
    ...
    <div className="grid min-h-screen place-items-center bg-background px-4">
      ...
      >
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <p className="text-xs text-muted-foreground">Use admin@eagle.com / password · 2FA: any 6 digits</p>
        </div>
          ...
          <div>
            ...
            <div className="relative mt-1.5">
              ...
              <Input id="code" inputMode="numeric" maxLength={6} value={code}
                ...
                className="h-12 pl-9 font-mono tracking-[0.5em]" />
            </div>
          </div>
